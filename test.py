...
TEST_IMG = ['136552115_6dc3e7231c.jpg', '246055693_ccb69ac5c6.jpg', '375392855_54d46ed5c8.jpg']
NUM_CAPTIONS = 5
...
for IMG in TEST_IMG:
    print('*' * 25)
    print(IMG)
    test_img = transform(Image.open(F"test_set/{IMG}").convert("RGB")).unsqueeze(0)
